...
#'
#' checks that each patient appears in at most one \code{col_by} column
#'
#' Where (possibly several times as \code{AVAL} corresponds to several measures and there are >= 1 rows per patient)
#'
#' @param id patient id
