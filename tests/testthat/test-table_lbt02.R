...
testthat::test_that("LBT02 default variant is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "50.0", "24.4 - 71.1", "", "134", "49.7 (7.7)", "49.7", "33.7 - 66.5",
      "", "134", "49.3 (8.7)", "48.3", "33.0 - 74.0", "", "134", "49.7 (8.4)",
      "50.2", "30.6 - 68.1", "C: Combination", "(N=132)", "", "132",
      "50.9 (7.8)", "50.8", "27.6 - 67.4", "", "132", "51.1 (7.8)",
      "50.8", "29.7 - 71.4", "", "132", "48.5 (7.2)", "49.2", "26.2 - 63.4",
      "", "132", "48.9 (7.9)", "47.7", "30.4 - 67.0", "", "132", "49.6 (8.0)",
      "49.8", "25.5 - 68.6", "", "132", "50.0 (8.3)", "51.0", "24.8 - 65.6"
    ),
    .Dim = c(32L, 4L)
  )
