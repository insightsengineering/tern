...
test_that("h_mmrm_fixed works as expected", {
  ...
  mmrm <- get_mmrm()
  result <- h_mmrm_fixed(mmrm, format = "xx.xxx")
  result2 <- as.rtable(mmrm, type = "fixed", format = "xx.xxx")
  ...
  expected_matrix <- structure(
    c("", "(Intercept)", "BMRKR2LOW", "BMRKR2MEDIUM", "ARMA: Drug X",
      ...
      "ARMC: Combination:AVISITWEEK 5 DAY 36", "Estimate", "52.056",
      "1.624", "-2.278", "0.121", "-3.303", "-5.173", "-1.459",
      "-1.584", "-1.198", "4.037", "5.413", "1.047", "5.444",
      "-1.6", "5.647", "-1.542", "6.92", "Std. Error", "2.501",
      "1.547", "1.231", "3.075", "3.264", "3.326", "3.408", "3.446",
      "3.414", "4.268", "4.519", "4.374", "4.631", "4.422", "4.682",
      "4.382", "4.639", "t value", "20.818", "1.05", "-1.851",
      "0.039", "-1.012", "-1.555", "-0.428", "-0.46", "-0.351",
      "0.946", "1.198", "0.239", "1.176", "-0.362", "1.206",
      "-0.352", "1.492", "df", "100", "142", "142", "88", "89", "150",
