...
test_that("summary by visit table", {
  ...
  # fixed result - based on built-in dataset CO2, displaying conc and uptake as sub-columns
  ...
  tbl_stream <- rtable(
    ...
    rrow("IQR", c(193.75,631.25), c(29.23, 41.2), c(212.5,587.5), c(11.85, 13.35), format = "xx.xx - xx.xx", indent = 1),
    ...
    rrow("IQR", c(193.75, 631.25), c(32.8, 41.93), c(212.5, 587.5), c(17.9, 18.45), format = "xx.xx - xx.xx", indent = 1),
