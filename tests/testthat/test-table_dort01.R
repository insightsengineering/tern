...
test_that("DORT01 variant 1 is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "7", "5", "35 (51.5%)", "", "23.81", "(17.9, 39.6)", "9.3, 44.3",
      "1.6 to 64.5", "0.3 to 44.3", "", "", "", "", "", "51", "83.63",
      "(74.78, 92.48)", "", "28", "63.41", "(50.48, 76.34)", "B: Placebo",
      "(N=73)", "51 (69.9%)", "14", "13", "5", "12", "7", "22 (30.1%)",
      "", "11.06", "(8.3, 14.6)", "6.2, 20.5", "0.1 to 43.8", "0.6 to 61.9",
      "", "0.0029", "1.9374", "(1.2436, 3.0184)", "", "48", "76.14",
      "(65.92, 86.35)", "", "25", "43.82", "(31.28, 56.36)", "C: Combination",
      "(N=62)", "53 (85.5%)", "11", "12", "11", "12", "7", "9 (14.5%)",
      "", "6.56", "(4.4, 9.2)", "3, 15.7", "0.2 to 39.6", "0.2 to 53.8",
      "", "<0.0001", "2.995", "(1.92, 4.6719)", "", "28", "50.57",
...
test_that("DORT01 variant 2 is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "", "23.81", "(17.9, 39.6)", "9.3, 44.3", "1.6 to 64.5", "0.3 to 44.3",
      "", "", "", "", "B: Placebo", "(N=73)", "51 (69.9%)", "14", "13",
      "5", "12", "7", "22 (30.1%)", "", "11.06", "(8.3, 14.6)", "6.2, 20.5",
      "0.1 to 43.8", "0.6 to 61.9", "", "0.0029", "1.9374", "(1.2436, 3.0184)",
      "C: Combination", "(N=62)", "53 (85.5%)", "11", "12", "11", "12",
      "7", "9 (14.5%)", "", "6.56", "(4.4, 9.2)", "3, 15.7", "0.2 to 39.6",
      "0.2 to 53.8", "", "<0.0001", "2.995", "(1.92, 4.6719)"
    ),
    .Dim = c(19L, 4L)
  )
...
test_that("DORT01 variant 3 is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "(N=73)", "51 (69.9%)", "14", "13", "5", "12", "7", "22 (30.1%)",
      "", "11.06", "(8.3, 14.6)", "6.2, 20.5", "0.1 to 43.8", "0.6 to 61.9",
      "", "0.0029", "1.9374", "(1.3355, 2.8107)", "", "48", "76.14",
      "(67.56, 84.71)", "", "25", "43.82", "(33.3, 54.34)", "C: Combination",
      "(N=62)", "53 (85.5%)", "11", "12", "11", "12", "7", "9 (14.5%)",
      "", "6.56", "(4.4, 9.2)", "3, 15.7", "0.2 to 39.6", "0.2 to 53.8",
      "", "<0.0001", "2.995", "(2.0623, 4.3496)", "", "28", "50.57",
