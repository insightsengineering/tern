...
# tabulate_survival_subgroups functions as expected with extreme values in subgroups
    ...
    Output
      ...
      Geographic Region 1                                                                                                     
        ...
        North America              2           2         1066.9       <no-value>    <no-value>      <no-value>     <no-value> 
...
# tabulate_survival_subgroups functions as expected when one arm has 0 records
    ...
    Output
      ...
      Race                                                                                                                                                                            
        ...
        NATIVE HAWAIIAN OR OTHER PACIFIC ISLANDER        1         1      1          370.4       0    <no-value>    <no-value>      <no-value>      <no-value>          <no-value>    
