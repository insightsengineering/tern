...
# a_summary work with healthy input.
    ...
    Output
      ...
      21                      CV (%)            590.4          0                      CV (%)
      22              Geometric Mean       <no-value>          0              Geometric Mean
      23       Geometric Mean 95% CI       <no-value>          0       Geometric Mean 95% CI
      24         CV % Geometric Mean       <no-value>          0         CV % Geometric Mean
...
# `analyze_vars` works with empty named numeric variables
    ...
    Output
      ...
      ——————————————————————————————————————————————
      n               0            2           2    
      Mean (SD)   <no-value>   3.5 (0.7)   5.5 (0.7)
      Median      <no-value>      3.5         5.5   
      Min - Max   <no-value>   3.0 - 4.0   5.0 - 6.0
