...
testthat::test_that("TTET01 variant 4: with stratified analysis", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "9.5, 54.9", "0.9 to 91", "0 to 122.4", "", "0.0334", "1.39",
      "(1.03, 1.9)", "", "0.0478", "1.36", "(1, 1.86)", "", "83", "70.32",
      "(62.27, 78.37)", "-7.71", "(-18.51, 3.1)", "0.1622", "C: Combination",
      "(N=132)", "116 (87.9%)", "", "21", "23", "24", "27", "21", "16 (12.1%)",
      "", "11.1", "(9.6, 15.9)", "5.3, 25.2", "0.3 to 49.4", "0.1 to 101.6",
      "", "<0.0001", "2.75", "(2.05, 3.7)", "", "<0.0001", "2.73",
...
testthat::test_that("TTET01 variant 5: modifying time point", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "9.5, 54.9", "0.9 to 91", "0 to 122.4", "", "0.0334", "1.39",
      "(1.03, 1.9)", "", "112", "89.16", "(83.8, 94.53)", "5.33", "(-2.97, 13.64)",
