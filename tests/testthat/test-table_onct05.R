...
test_that("ONCT05 variant 1 (Objective Response Rate by Subgroup) is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "88.1%", "", "89.5%", "90.7%", " ", "Total n", "200", "", "120",
      "80", "", "105", "95", " ", "Odds Ratio", "3.68", "", "5.83",
      "1.67", "", "3.5", "3.95", " ", "95% CI", "(1.68, 8.04)", "",
      "(2.03, 16.73)", "(0.48, 5.79)", "", "(1.22, 10)", "(1.2, 13.01)"
      ),
    .Dim = 9:8
    )
...
test_that("ONCT05 variant 4 (setting values indicating response) is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      "", "", "All Patients", "Sex", "F", "M", "Stratification Factor 2",
      "S1", "S2", "B: Placebo", "n", "100", "", "62", "38", "", "48",
      "52", "B: Placebo", "Response (%)", "95%", "", "96.8%", "92.1%",
      "", "97.9%", "92.3%", "A: Drug X", "n", "100", "", "58", "42",
      "", "57", "43", "A: Drug X", "Response (%)", "99%", "", "98.3%",
      "100%", "", "100%", "97.7%", " ", "Total n", "200", "", "120",
      "80", "", "105", "95", " ", "Odds Ratio", "5.21", "", "1.9",
      ">999.99", "", ">999.99", "3.5", " ", "95% CI", "(0.6, 45.43)",
