context("test MMRM tabulation functions")
...
test_that("Summary of Mixed-effect Model Repeated Measures Analysis", {
  ...
  tbl_stream <- rtable(
    ...
    rrow(),
    rrow("p-value (MMRM)", numeric(0), rcell(c(0.9115), "x.xxxx | (<0.0001)"), rcell(c(0.3189), "x.xxxx | (<0.0001)"), indent = 1),
    rrow(),
    rrow("WEEK 2 DAY 15"),
    rrow("n", rcell(c(11), "xx"), rcell(c(17), "xx"), rcell(c(13), "xx"), indent = 1),
    ...
    rrow(),
    rrow("p-value (MMRM)", numeric(0), rcell(c(0.1582), "x.xxxx | (<0.0001)"), rcell(c(0.4732), "x.xxxx | (<0.0001)"), indent = 1),
    rrow(),
    rrow("WEEK 3 DAY 22"),
    rrow("n", rcell(c(11), "xx"), rcell(c(17), "xx"), rcell(c(13), "xx"), indent = 1),
    ...
    rrow(),
    rrow("p-value (MMRM)", numeric(0), rcell(c(0.6464), "x.xxxx | (<0.0001)"), rcell(c(0.4535), "x.xxxx | (<0.0001)"), indent = 1),
    rrow(),
    rrow("WEEK 4 DAY 29"),
    rrow("n", rcell(c(11), "xx"), rcell(c(17), "xx"), rcell(c(13), "xx"), indent = 1),
    ...
    rrow(),
    rrow("p-value (MMRM)", numeric(0), rcell(c(0.6778), "x.xxxx | (<0.0001)"), rcell(c(0.4289), "x.xxxx | (<0.0001)"), indent = 1),
    rrow(),
    rrow("WEEK 5 DAY 36"),
    rrow("n", rcell(c(11), "xx"), rcell(c(17), "xx"), rcell(c(13), "xx"), indent = 1),
    ...
    rrow(),
    rrow("p-value (MMRM)", numeric(0), rcell(c(0.7057), "x.xxxx | (<0.0001)"), rcell(c(0.2607), "x.xxxx | (<0.0001)"), indent = 1)
  )
  # nolint end
...
test_that("t_mmrm_lsmeans works correctly", {
  anl <- get_anl() %>%
    mutate(
      ARM = factor(ARM, levels = c("B: Placebo", "A: Drug X", "C: Combination")),
      AVISIT = factor(AVISIT)
