...
testthat::test_that("LBT03 default variant is produced correctly", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "49.57", "23.97 - 70.85", "", "134", "-0.97 (11.70)", "-1.02",
      "-25.05 - 39.39", "", "134", "-0.16 (12.01)", "0.08", "-26.31 - 34.35",
      "", "134", "0.69 (11.52)", "0.90", "-32.07 - 32.51", "", "134",
      "1.13 (13.01)", "0.71", "-34.00 - 37.59", "", "134", "1.26 (12.11)",
      "1.85", "-32.06 - 32.18", "B: Placebo", "(N=134)", "", "134",
      "50.31 (8.34)", "50.15", "26.22 - 79.12", "", "134", "0.14 (12.07)",
      "-1.45", "-24.58 - 34.81", "", "134", "-0.06 (12.53)", "-0.74",
      "-36.75 - 28.78", "", "134", "-0.63 (11.21)", "-0.36", "-37.04 - 30.00",
      "", "134", "-1.04 (12.59)", "-2.37", "-33.16 - 34.47", "", "134",
      "-0.59 (12.63)", "1.46", "-38.08 - 25.27", "C: Combination",
      "(N=132)", "", "132", "50.90 (7.82)", "50.77", "27.63 - 67.45",
      "", "132", "0.20 (10.92)", "0.05", "-27.38 - 31.08", "", "132",
      "-2.41 (10.97)", "-0.96", "-28.56 - 31.29", "", "132", "-2.05 (11.10)",
      "-2.13", "-24.65 - 22.20", "", "132", "-1.25 (10.62)", "-1.29",
      "-24.26 - 30.60", "", "132", "-0.92 (11.14)", "-1.98", "-31.24 - 33.22"
    ),
    .Dim = c(32L, 4L)
  )
