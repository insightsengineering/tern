...
testthat::test_that("s_summary return NA for x length 0L", {
  ...
  expected <- list(
    ...
    mad = c(mad = NA_real_),
    median_ci = formatable::with_label(c(median_ci_lwr = NA_real_, median_ci_upr = NA_real_), "Median 95% CI"),
...
testthat::test_that("s_summary handles NA", {
  ...
  expected <- list(
    ...
    mad = c(mad = 0),
    median_ci = formatable::with_label(c(median_ci_lwr = NA_real_, median_ci_upr = NA_real_), "Median 95% CI"),
    quantiles = formatable::with_label(c(quantile_0.25 = 1, quantile_0.75 = 1), "25% and 75%-ile"),
    iqr = c(iqr = 0),
    range = c(min = 1, max = 1),
    min = c(min = 1),
    max = c(max = 1),
...
testthat::test_that("s_summary returns right results for n = 8", {
  ...
  expected <- list(
    ...
    mean_ci = formatable::with_label(c(mean_ci_lwr = 3.318768, mean_ci_upr = 8.681232), "Mean 95% CI"),
    mean_sei = formatable::with_label(c(mean_sei_lwr = 4.866107, mean_sei_upr = 7.133893), "Mean -/+ 1xSE"),
    mean_sdi = formatable::with_label(c(mean_sdi_lwr = 2.792865, mean_sdi_upr = 9.207135), "Mean -/+ 1xSD"),
    median = c(median = 6.5),
    mad = c(mad = 0),
    median_ci = formatable::with_label(c(median_ci_lwr = 1, median_ci_upr = 10), "Median 95% CI"),
    quantiles = formatable::with_label(c(quantile_0.25 = 3.5, quantile_0.75 = 8.5), "25% and 75%-ile"),
    iqr = c(iqr = 5),
    ...
    geom_mean_ci = formatable::with_label(c(mean_ci_lwr = 2.456211, mean_ci_upr = 9.547283), "Geometric Mean 95% CI"),
