...
testthat::test_that("RSPT01: 4. Best Overall Response (with stratified analysis)", {
  ...
  expected_matrix <- structure(
    c(
      ...
      "84 (62.7%)", "(54.1, 71.2)", "", "11.9", "(0.2, 23.7)", "0.0416",
