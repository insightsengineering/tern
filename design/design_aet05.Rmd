...
s_adjusted_rate <- function(
  ...
  list(
    ...
    num_events = formatable::with_label(num_events, "Number of adverse events observed"),
    rate = formatable::with_label(rate, paste("AE rate per", time_unit, "patient-years")),
    rate_ci = formatable::with_label(rate_ci, f_conf_level(conf_level))
  )
