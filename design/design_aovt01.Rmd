...
s_ancova <- function(df,
  ...
  if (.in_ref_col) {
    list(
      ...
      lsmean_diff = formatable::with_label("", "Difference in Adjusted Means"),
      lsmean_diff_ci = formatable::with_label("", tern:::f_conf_level(conf_level)),
      pval = formatable::with_label("", "p-value")
    )
  } else {
    ...
    list(
      ...
      lsmean_diff_ci = formatable::with_label(c(
...
summarize_ancova <- function(lyt,
  ...
  a_ancova <- tern:::format_wrap_df(
    ...
    formats = c(
      "n" = "xx", "lsmean" = "xx.xx", "lsmean_diff" = "xx.xx", "lsmean_diff_ci" = "xx.xx - xx.xx",
      "pval" = "x.xxxx | (<0.0001)"
    )
  )
  analyze(
