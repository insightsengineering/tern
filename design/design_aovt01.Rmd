...
s_ancova <- function(df,
  ...
  if (.in_ref_col) {
    list(
      ...
      lsmean_diff = formatters::with_label("", "Difference in Adjusted Means"),
      lsmean_diff_ci = formatters::with_label("", tern:::f_conf_level(conf_level)),
      pval = formatters::with_label("", "p-value")
    )
  } else {
    ...
    list(
      ...
      lsmean_diff_ci = formatters::with_label(c(
