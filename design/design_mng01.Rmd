...
# Mean with CI
g_lineplot(adlb)
# temporary until tern prerequisites are ready
g_lineplot(adlb, stat_fun = s_summary.numeric, table_format = summary_formats(), table_labels = summary_labels())

# Mean, upper whisker of CI
g_lineplot(adlb, whiskers = "upr", title = "Plot of Mean and Upper 95% Confidence Limit by Visit")
# temporary until tern prerequisites are ready
g_lineplot(adlb, whiskers = "upr", title = "Plot of Mean and Upper 95% Confidence Limit by Visit",
           stat_fun = s_summary.numeric, table_format = summary_formats(), table_labels = summary_labels())
