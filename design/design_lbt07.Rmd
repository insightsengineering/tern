...
Additionally, the `abnormal` argument is now only going to be used for selecting the labels for "LOW"/"HIGH". 
If we want them to keep as "Low"/"High" this argument could be removed. 
...
* Example 2: All grades in the target direction (none 0). 
* Example 3: All grades in an opposite direction 
* Example 4: All grades for all params 0. 
...
#This is the expected output. 0 records are shown
build_table(
  lyt = lyt_trim_map,
  df = adlb_f3,
  alt_counts_df = adsl
