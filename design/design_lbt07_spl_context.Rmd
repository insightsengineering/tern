...
#Let's update `map` dataframe by removing "NORMAL" rows as the layout properly works without them 
map <- map[map$ANRIND != "NORMAL", ]
...
lyt_trim_map <- basic_table() %>%
  ...
  append_topleft("    Highest NCI CTCAE Grade") %>% build_table(adlb_f)
