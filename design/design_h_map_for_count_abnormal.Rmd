...
h_map_for_count_abnormal <- function(
  ...
  assert_that(
    length(normal_value) == 1 # how do I do a python assert() so that I can have customized error message.
    # Here I mainly want to capture if the abnormals are all included (LOW LOW and HIGH HIGH)
  )
  ...
  if (method == "default") {
    ...
    assert_that(
      ...
      # also need some assert that abnormal should have low and high direction
    )
