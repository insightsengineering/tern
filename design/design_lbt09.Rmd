...
# At the terminal, run:
# scp <username>@bee.roche.com:/opt/bee/analyses/stream2/master/2.11/stream2/doc/examples/molecule/project/safety/task01/outdata_vad/adhy.sas7bdat
...
# Create ALTAST_CAT categories variable - this will be the labels for different ALT/AST categories displayed in the table.
adhy_liver <- adhy_liver %>%
  mutate(
    ALTAST_CAT = factor(
      case_when(
      ...
      levels = c("ALT >3 - <= 5xULN", "ALT >5 - <= 10xULN", "ALT >10 - <= 20xULN", "20" = "ALT > 20xULN",
