...
adhy_liver <- adhy_liver %>%
  dplyr::mutate(AVISIT = factor(AVISIT, levels = c("BASELINE", "POST-BASELINE")),
...
map <- data.frame(
  ...
  ALTAST_CAT = c(
    "ALT >3 - <= 5xULN", "ALT >5 - <= 10xULN", "ALT >10 - <= 20xULN", "20" = "ALT > 20xULN", "Criteria not met",
