...
# 1. “single, not last” and “last or replicated” categories should be mutually exclusive. If a patient has abonormalities
# that meet both the "single, not last" and "last or replicated" criteria, then the patient will be counted only under 
# the "last or replicated" category.
