...
pth <- "/opt/bee/analyses/stream2/master/2.11/stream2/doc/examples/molecule/project/safety/task01/outdata_vad/"
...
#1. “single, not last” and “last or replicated” categories should be mutually exclusive. If a patient has abonormalities that meet both the "single, not last" and "last or replicated" criteria, then the patient will be counted only under the "last or replicated" category.
# Hence, in order the patient not to be considered in "single", when is "last or replicated" we are creating AVALCAT1_NUM, and using this variable to later create the final AVALCAT1_FL analysis variable. 
