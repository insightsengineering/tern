...
c_foo <- make_afun(
  ...
  .labels = c(unique_subj = "Number of patients with at least one event",
...
stack_df_by_smq <- function(df, smq, flag_var = "SMQ") {
  ...
  df_labels <- c(var_labels(df), "MedDRA Query")
