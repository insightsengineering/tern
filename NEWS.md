...
*  Added stable badge for:
   ...
   `decorate_grob_set`, `extreme_format`, `fit_rsp_step`, `fit_survival_step`, `footnotes`, `footnotes-set` (note: this function is defined twice in the footnotes file), `format_count_fraction`, `format_fraction_threshold`, `formatting_functions`, `format_fraction` .
