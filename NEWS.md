...
### Enhancements
*  Added a badge to 114 `tern` methods (88 stable, 6 deprecated, 1 experimental, 19 internal)
*  Added `tern:::` prefix for references to internal methods in tests, examples, and vignettes
   and cleaned up `_pkgdown.yml` file accordingly
