...
* Began deprecation of no longer used Kaplan-Meier helper functions `h_data_plot`, `h_ggkm`, `h_decompose_gg`, `h_km_layout`, `h_grob_tbl_at_risk`, `h_grob_median_surv`, `h_grob_y_annot`, and `h_grob_coxph`.
