...
See below for the list of formatting functions created in `tern` to work
with `rtables`.
...
[`formatters::sprintf_format()`](https://insightsengineering.github.io/formatters/latest-tag/reference/sprintf_format.html)
function.
