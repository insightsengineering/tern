...
We could find out that `tern` offers more advanced analytics with only a one code line updated compared to the pure `rtables` code. 
...
The control slot is used only in the part of the high level functions.
