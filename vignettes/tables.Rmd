...
As there is no one prefix to identify all `tern` analyze functions it is recommended to use the reference subsection on [the pkgdown tern website](https://insightsengineering.github.io/tern/reference/index.html).
...
In this vignette we are going to create 3 different tables using `tern` analyze functions and the `rtables` interface.
