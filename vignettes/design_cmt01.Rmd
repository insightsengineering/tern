...
## Variant 3: Remove "Total number of treatments" row within each class
This is not possible at the moment. It will be possible in the future when the "summarize_row_groups" function takes extra arguments


## Variant 4: Sort data by total column frequency from most to least frequently reported medication class
Within a medication class, sort by decreasing total number of patients with the specific medication. This is currently not implemented. I did not find a way to use sort_at_path function here.
