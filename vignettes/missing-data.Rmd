...
Missing values in factor variables assigned to the `col_by` agruments will cause an error.
...
There are more ways to recode `NAs` in factor variables as described in this
[stackoverflow
