...
t_summary.default <- function(x, col_by, col_n = table(col_by), ...) { # nolint
...
t_summary.data.frame <- function(x, col_by, col_n = table(col_by), total = NULL, ...) { # nolint
...
t_summary.numeric <- function(x, col_by, col_n = table(col_by), total = NULL, ...) { # nolint
...
t_summary.character <- function(x, col_by, col_n = table(col_by), total = NULL, ...) { # nolint
...
t_summary.Date <- function(x, col_by, col_n = table(col_by), total = NULL,  ...) { # nolint
