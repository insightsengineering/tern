...
#' @describeIn count_patients_with_flags Statistics function which given occurrence data counts the
...
#' @describeIn count_patients_with_flags Formatted Analysis function which can be further customized by calling
...
#' @param label_row (`character`)\cr title to be displayed in a row above the flag variable count statistics
#'
