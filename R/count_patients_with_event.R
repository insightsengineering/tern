...
#' @param title_row (`character`)\cr title to be displayed in a row above the flag variable count statistics
#'
...
count_patients_with_flags <- function(lyt,
  ...
  title_fun <- make_afun(
    fun = function(x) list(title = ""),
    .labels = c(title = title_row)
  )
