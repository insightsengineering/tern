...
#'
#' res <- g_km_old(df = df, variables = variables)
#' res <- g_km_old(df = df, variables = variables, yval = "Failure")
#' res <- g_km_old(
#'   df = df,
#'   variables = variables,
...
#' )
#' res <- g_km_old(df = df, variables = variables, ggtheme = theme_minimal())
#' res <- g_km_old(df = df, variables = variables, ggtheme = theme_minimal(), lty = 1:3)
#' res <- g_km_old(df = df, variables = variables, max_time = 2000)
#' res <- g_km_old(
#'   df = df,
#'   variables = variables,
