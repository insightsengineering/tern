...
#'     fl2 = (TRTEMFL == "Y") %>% with_label("Total number of patients with at least one adverse event"),
#'     fl3 = (TRTEMFL == "Y" & AEOUT == "FATAL") %>% with_label("Total number of patients with fatal AEs"),
